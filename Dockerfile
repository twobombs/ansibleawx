...
RUN apt update && apt install -y gnupg && apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 93C4A3FD7BB9C367 && apt update && apt install -y ansible docker.io curl && apt-get clean all
