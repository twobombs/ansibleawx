...
RUN apt update && apt install -y gnupg software-properties-common wget source && apt-add-repository -y ppa:ansible/ansible-2.7 && apt update && apt install -y ansible docker.io curl && apt-get clean all
